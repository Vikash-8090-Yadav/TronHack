      ...
      <div className="min-h-screen py-10 bg-gradient-to-r from-green-700 to-green-300">
        ...
        <div className="container mx-auto mt-3">
          ...
          <div className="md:w-1/2 bg-black flex flex-col justify-center items-center">
            ...
            <div>
              <p className='text-justify px-4 text-white'>Congratulations on taking the step to become a part of our vibrant community! By contributing your unique items to "TRON STORE," you're not just listing products; you're creating opportunities for others to discover and own exceptional pieces. Your participation in our marketplace enriches the experience for all, fostering a dynamic environment for collectors and enthusiasts alike. Thank you for being an integral part of our growing network of passionate traders and buyers.</p>
            </div>
          </div>
